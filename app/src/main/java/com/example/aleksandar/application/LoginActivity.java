        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                if (isNetworkAvailable()) {
                    ...
                    getRequest.sendRequest(getApplicationContext(), mEmail, mPassword);

                    JsonParser jsonParserObj = new JsonParser();
                    jsonParserObj.jsonParser(getRequest.getResponse_string());

                    categoriesArrayList = jsonParserObj.getCategories();
